                    ...
                    <div className="text-center space-y-6">
                        ...
                        >
                            <button
                                ...
                                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl text-white font-semibold text-lg transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
        ...
        <div className="min-h-screen p-6 md:p-8" style={{ backgroundColor: '#09090b' }}>
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        onClick={() => setShowAddModal(true)}
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-white font-medium transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                            ...
                            <div className="h-2 rounded-full overflow-hidden" style={{ backgroundColor: '#27272a' }}>
                                <div
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: weeklyStats.percentage >= 100 ? '#10b981' : '#3b82f6'
                                    }}
                                />
                            </div>
                        </div>
                    ...
                    <div className="rounded-2xl p-5 space-y-4" style={{ backgroundColor: '#18181b', border: '1px solid #27272a' }}>
                        ...
                        <div>
                            ...
                            <div className="h-2 rounded-full overflow-hidden" style={{ backgroundColor: '#27272a' }}>
                                <div
                                    className="h-full rounded-full transition-all"
                                    style={{ width: `${Math.min(dailyStats.percentage, 100)}%`, backgroundColor: '#8b5cf6' }}
                                />
                            </div>
                        </div>
                    </div>
...
function BadgeCard({ badge }: { badge: BadgeType }) {
    ...
    return (
        <div className="rounded-xl px-4 py-3 flex items-center gap-3" style={{ backgroundColor: '#18181b', border: '1px solid #27272a' }}>
            <div className="w-10 h-10 rounded-lg flex items-center justify-center shadow-lg" style={{ background: 'linear-gradient(135deg, #f59e0b, #ea580c)' }}>
                <Award className="w-5 h-5 text-white" />
            </div>
            <div>
                <p className="font-medium text-sm" style={{ color: 'white' }}>{config.label}</p>
                <p className="text-xs" style={{ color: '#71717a' }}>{config.description}</p>
            </div>
        </div>
    );
}
