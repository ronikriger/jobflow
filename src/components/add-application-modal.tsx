                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {url && platform !== "other" && (
                                        ...
                                        >
                                            Detected: <span className="text-primary font-medium">{PLATFORM_CONFIG[platform].label}</span>
                                        </motion.p>
                                    )}
                                </div>
                                ...
                                <div className="flex gap-3 pt-2">
                                    <button
                                        type="button"
                                        onClick={onClose}
                                        className="flex-1 px-4 py-3 rounded-xl font-medium bg-secondary hover:bg-secondary/80 transition-colors"
                                    >
                                        Cancel
                                    </button>
                                    <button
